            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(email) && !TextUtils.isEmpty(pass) & !TextUtils.isEmpty(confirm_pass)){
                    ...
                    if(pass.equals(confirm_pass)){
                        ...
                        mAuth.createUserWithEmailAndPassword(email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    Intent setupIntent = new Intent(RegisterAct.this, ProfileAct.class);
                                    ...
                                    Toast.makeText(RegisterAct.this, "Error : " + errorMessage, Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(RegisterAct.this, "Confirm Password and Password Field doesn't match.", Toast.LENGTH_LONG).show();
